...
On Error Resume Next
    ...
    frmCargando.Label1(2).Caption = "Cargando CentroCanjes.Dat"
    Call LoadCanjeList
...
'***************************************************
    ...
    With UserList(UserIndex)
        If .Counters.Paralisis > 0 Then
            ...
            If TiempoTranscurrido Mod 1000 = 0 Or TiempoTranscurrido = 40 Then
                If TiempoTranscurrido = 40 Then
                    Call WriteParaTime(UserIndex, ((IntervaloParalizado * frmMain.GameTimer.Interval) / 1000))
                Else
                    Call WriteParaTime(UserIndex, (((IntervaloParalizado * frmMain.GameTimer.Interval) / 1000) - (TiempoTranscurrido / 1000)))
                End If
            End If
        ...
        Else
            ...
            'Standelf
            Call WriteParaTime(UserIndex, 0)
        End If
    End With
        ...
        If UserList(i).flags.UserLogged Then
            ...
            If UserList(i).Counters.Saliendo Then
                ...
                If UserList(i).Counters.Salir <= 0 Then
                    ...
                    If EsGM(i) Then
                        Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> El GameMaster " & UserList(i).name & " se retiró de las tierras de Blisse-AO.", FontTypeNames.FONTTYPE_FIGHT))
                    End If
...
'***************************************************
    ...
    For i = 1 To LastUser
        If UserList(i).flags.UserLogged Then
            Call SaveUser(i, CharPath & UCase$(UserList(i).name) & ".chr", True)
        End If
    Next i
