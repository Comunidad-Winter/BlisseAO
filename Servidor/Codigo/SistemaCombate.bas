        ...
        If .Invent.WeaponEqpObjIndex > 0 Then
            ...
            If NpcIndex > 0 Then
                ...
                Else
                    ...
                    If .Invent.WeaponEqpObjIndex = EspadaMataDragonesIndex Or .Invent.WeaponEqpObjIndex = BaculoMataDragonesIndex Then ' Usa la mata Dragones?
            ...
            Else ' Ataca usuario
                ...
                Else
                    ...
                    If .Invent.WeaponEqpObjIndex = EspadaMataDragonesIndex Or .Invent.WeaponEqpObjIndex = BaculoMataDragonesIndex Then
                        ModifClase = ModClase(.clase).DañoArmas
...
'***************************************************
    ...
    With Npclist(NpcIndex)
        ...
        'Khalem
        If UserList(UserIndex).flags.Metamorfosis = 1 Then daño = daño * 2 'Metamorfosi
...
'***************************************************
    ...
    With Npclist(Atacante)
        ...
        Call SendData(SendTarget.ToPCArea, Atacante, PrepareMessageChatOverHead("-" & daño, Npclist(Victima).Char.CharIndex, vbRed))
...
Public Function UsuarioAtacaNpc(ByVal UserIndex As Integer, ByVal NpcIndex As Integer, Optional ByVal Flecha As Boolean = False) As Boolean
'***************************************************
'Author: Unknown
...
On Error GoTo Errhandler
    ...
    If UserImpactoNpc(UserIndex, NpcIndex) Then
        ...
        If Flecha = True Then Call SendProjectile(UserIndex, NpcIndex, 2, True, False)
    ...
    Else
        ...
        If Flecha = True Then Call SendProjectile(UserIndex, NpcIndex, 2, True, True)
    End If
...
'***************************************************
    ...
    With UserList(UserIndex)
        ...
        'Look for user
        If index > 0 Then
            Call UsuarioAtacaUsuario(UserIndex, index, False)
...
Public Function UsuarioAtacaUsuario(ByVal AtacanteIndex As Integer, ByVal VictimaIndex As Integer, Optional ByVal Flecha As Boolean = False) As Boolean
'***************************************************
'Author: Unknown
'Last Modification: 14/01/2010 (ZaMa)
...
On Error GoTo Errhandler
    ...
    With UserList(AtacanteIndex)
        ...
        If UsuarioImpacto(AtacanteIndex, VictimaIndex) Then
            ...
            If Flecha = True Then Call SendProjectile(AtacanteIndex, VictimaIndex, 2, False, False)
        Else
            ...
            If Flecha = True Then Call SendProjectile(AtacanteIndex, VictimaIndex, 2, False, True)
        End If
...
On Error GoTo Errhandler
    ...
    With UserList(AtacanteIndex)
        ...
        Call SendData(SendTarget.ToPCArea, VictimaIndex, PrepareMessageChatOverHead("-" & daño, UserList(VictimaIndex).Char.CharIndex, vbRed))
...
'***************************************************
    ...
    ExpaDar = CLng(ElDaño * ((Npclist(NpcIndex).GiveEXP * MultExp) / Npclist(NpcIndex).Stats.MaxHp))
 ...
 '   End If
    ...
    'TonchitoZ: Asignamos la experiencia si es VIP o no lo es
    Dim CuentaName As String
    CuentaName = GetVar(App.Path & "\Charfile\" & UserList(UserIndex).name & ".CHR", "INIT", "CUENTA")
    
    If GetVar(App.Path & "\Cuentas\" & CuentaName & ".bgao", "CUENTA", "PREMIUM") = True Then
        If UserList(UserIndex).PartyIndex > 0 Then
            ExpaDar = ExpaDar * RandomNumber(MultExp - 5, MultExp)
        Else
            ExpaDar = ExpaDar * RandomNumber(HHExp - 5, HHExp)
        End If
    Else
        ExpaDar = ExpaDar * RandomNumber(MultExp - 5, MultExp)
    End If
