...
Public Const LimiteNewbie As Byte = 16
...
'Standelf
Public Const BaculoMataDragonesIndex As Integer = 1085
Public Const SpellMataDragonesIndex As Byte = 47
...
'   Standelf
Public Const HACHA_LEÑADOR_NW As Integer = 561
Public Const PIQUETE_MINERO_NW As Integer = 562
Public Const CAÑA_PESCA_NW As Integer = 563
Public Const SERRUCHO_CARPINTERO_NW As Integer = 564
Public Const MARTILLO_HERRERO_NW As Integer = 565
'   /Standelf
...
'TonchitoZ: Evento DeathMatch
Public Const FONTTYPE_DEATHMATCH As String = "~0~128~255~1~0"
...
Public Type User
    ...
    'Standelf, prestigio
    PrestigioC As Integer 'Nunca nadie va a tener mas de 32k ni negativo :)
    PrestigioR As Integer 'Nunca nadie va a tener mas de 32k ni negativo :)
