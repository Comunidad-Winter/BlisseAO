            ...
            If .Stats.UserSkills(eSkill.Liderazgo) >= 5 Then
                ...
                Else
                    ...
                    Else
                        ...
                        End If
                        Call WritePartyDetails(Userindex)
                    End If
                End If
            Else
...
If PI > 0 Then
    ...
    Else
        Call ActualizarPartyAllMembers(UserList(Userindex).PartyIndex)
        UserList(Userindex).PartyIndex = 0
        Call WritePartyKicked(Userindex)
    End If
Else
...
If PI = UserList(OldMember).PartyIndex Then
    ...
    Else
        ...
        Call WritePartyKicked(OldMember)
    End If
Else
                ...
                If .PartyIndex = 0 Then
                    If Parties(PI).PuedeEntrar(NewMember, razon) Then
                        If Parties(PI).NuevoMiembro(NewMember) Then
                            ...
                            Call ActualizarPartyAllMembers(.PartyIndex)
                        Else
                            'no pudo entrar
...
Public Sub ActualizarPartyAllMembers(ByVal PartyIndex As Integer)
Dim MembersOnline(1 To PARTY_MAXMEMBERS) As Integer, i As Byte
        ...
        For i = 1 To PARTY_MAXMEMBERS
            If MembersOnline(i) <> 0 Then
                Call WritePartyDetails(MembersOnline(i))
            End If
        Next i
