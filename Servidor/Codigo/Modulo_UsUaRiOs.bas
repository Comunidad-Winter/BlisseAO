        ...
        If .flags.Hambre = 0 And .flags.Sed = 0 Then
            ...
            With .Stats
                ...
                If .ExpSkills(Skill) >= .EluSkills(Skill) Then
                    ...
                    Dim ExpRecompensa As Integer
                    ExpRecompensa = (50 + UserList(UserIndex).Stats.ELV * 2)
                    .Exp = .Exp + ExpRecompensa
                    If .Exp > MAXEXP Then .Exp = MAXEXP
                    
                    Call WriteConsoleMsg(UserIndex, "¡Has ganado " & ExpRecompensa & " puntos de experiencia!", FontTypeNames.FONTTYPE_FIGHT)
...
On Error GoTo ErrorHandler
    ...
    With UserList(UserIndex)
        ...
        If .flags.Navegando = 0 Then
                'khalem
            If Not .flags.Metamorfosis = 1 Then 'Metamorfosis
        ...
        If Not MapData(.Pos.Map, .Pos.X, .Pos.Y).trigger = eTrigger.ZONASEGURA And Not MapData(.Pos.Map, .Pos.X, .Pos.Y).trigger = NADA Then
