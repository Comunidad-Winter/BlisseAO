    ...
    For i = 0 To 2
        ...
        If MiObj(i).Amount > 0 Then
            If Not MeterItemEnInventario(UserIndex, MiObj(i)) Then
                ...
                Call UserItemsSound(UserIndex, ObjData(MiObj(i).ObjIndex).OBJType)
            End If
...
If res <= 6 Then
    ...
    If UserList(UserIndex).clase = eClass.Worker Then
        ...
        CantidadItems = CantidadItems * MultTrabajo
...
If Suerte > 0 Then
    ...
    If res < 6 Then
        ...
        If EsPescador = True Then
            MiObj.Amount = (RandomNumber(1, 5)) * MultTrabajo
        Else
            MiObj.Amount = 1
        End If
...
If flag Then
    ...
    If Not MeterItemEnInventario(LadrOnIndex, MiObj) Then
        ...
        Call UserItemsSound(LadrOnIndex, ObjData(MiObj.ObjIndex).OBJType)
    End If
