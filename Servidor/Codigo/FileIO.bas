...
On Error GoTo Errhandler
    ...
    For Hechizo = 1 To NumeroHechizos
        With Hechizos(Hechizo)
            ...
            'Standelf
            .Projectile = Leer.GetValue("Hechizo" & Hechizo, "Projectile")
        ...
        With ObjData(Object)
            ...
            Select Case .OBJType
                Case eOBJType.otArmadura
                    ...
                    .Aura = val(Leer.GetValue("OBJ" & Object, "Aura")) 'Standelf, Auras
            ...
            'Khalem
            .Meta = val(Leer.GetValue("OBJ" & Object, "Meta")) 'Metamorfosis
...
With UserList(UserIndex)
    With .Stats
        ...
        .DuelosGanados = CByte(UserFile.GetValue("STATS", "DGANADOS"))
        .DuelosPerdidos = CByte(UserFile.GetValue("STATS", "DPERDIDOS"))
...
'*************************************************
    ...
    With UserList(UserIndex)
        ...
        With .flags
            ...
            'Khalem
            .Metamorfosis = CByte(UserFile.GetValue("FLAGS", "Metamorfosis")) 'Metamorfosis
        ...
        .PrestigioC = UserFile.GetValue("PRESTIGIO", "PRESTIGIOC")
        .PrestigioR = UserFile.GetValue("PRESTIGIO", "PRESTIGIOR")
        ...
        For LoopC = 1 To MAX_INVENTORY_SLOTS
            ...
            If .Invent.Object(LoopC).ObjIndex <> 0 Then
                If ObjData(.Invent.Object(LoopC).ObjIndex).Aura <> 0 And .Invent.Object(LoopC).Equipped = 1 Then
                    Call SetAura(UserIndex, ObjData(.Invent.Object(LoopC).ObjIndex).Aura, FindSlotFreeAura(UserIndex), False)
                End If
            End If
        Next LoopC
...
Sub SaveUser(ByVal UserIndex As Integer, ByVal UserFile As String, Optional ByVal Web As Boolean = False)
'*************************************************
'Author: Unknown
...
With UserList(UserIndex)
    ...
    'Khalem
    Call WriteVar(UserFile, "FLAGS", "Metamorfosis", CStr(.flags.Metamorfosis)) 'Metamorfosis
    ...
    Call WriteVar(UserFile, "PRESTIGIO", "PRESTIGIOC", .PrestigioC)
    Call WriteVar(UserFile, "PRESTIGIO", "PRESTIGIOR", .PrestigioR)
    ...
    Call WriteVar(UserFile, "STATS", "DPERDIDOS", CStr(.Stats.DuelosPerdidos))
    Call WriteVar(UserFile, "STATS", "DGANADOS", CStr(.Stats.DuelosGanados))
...
End With
    ...
    If Web Then Call WriteCreateOrUpdate(UserIndex)
Exit Sub
...
'***************************************************
    ...
    Call WriteVar(App.Path & "\logs\" & "BanDetail.dat", BannedName, "Reason", Motivo)
        'Khalem
    Call WriteVar(App.Path & "\logs\" & "BanDetail.dat", BannedName, "Fecha", Date)
