...
Begin VB.Form frmComerciarUsu 
   ...
   Begin RichTextLib.RichTextBox CommerceConsole 
      ...
      Appearance      =   0
      TextRTF         =   $"frmComerciarUsu.frx":32E32
...
Private Sub Form_Load()
    ...
    Me.Picture = General_Set_GUI("VentanaComercioUsuario")
...
Private Sub LoadButtons()
    ...
    GrhPath = General_Get_Graphics_Path
...
Public Sub PrintCommerceMsg(ByRef msg As String, ByVal FontIndex As Integer)
    ...
    With FontTypes(FontIndex)
        Call General_Add_to_RichTextBox(frmComerciarUsu.CommerceConsole, msg, .Red, .Green, .Blue, .bold, .italic)
    End With
