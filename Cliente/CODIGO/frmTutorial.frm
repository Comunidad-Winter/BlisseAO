...
Private Sub Form_Load()
    ...
    Me.Picture = General_Load_Picture_From_Resource("VentanaTutorial")
    imgSiguiente.Picture = General_Load_Picture_From_Resource("anterior")
    imgAnterior.Picture = General_Load_Picture_From_Resource("anterior")
