...
Begin VB.Form frmCharInfo 
   ...
   Begin VB.TextBox txtMiembro 
      ...
      Width           =   5730
   End
   Begin CLBLISSEAO.BGAOButton imgEchar 
      Height          =   465
      Left            =   1515
      TabIndex        =   16
      Top             =   5925
      ...
      FontSize        =   8,25
   End
   Begin CLBLISSEAO.BGAOButton imgPeticion 
      Height          =   465
      Left            =   2715
      TabIndex        =   17
      Top             =   5925
...
Private Sub Form_Load()
    ...
    Me.Picture = General_Set_GUI("VentanaInfoPj")
        
    imgAceptar.Init sb_Normal
    imgRechazar.Init sb_Normal
    imgPeticion.Init sb_Normal
    imgEchar.Init sb_Normal
