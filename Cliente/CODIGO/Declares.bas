...
'     Constantes necesarias... Necesarias?
...
Public InvComUsu As New clsGrapchicalInventory
Public InvOroComUsu(2) As New clsGrapchicalInventory
Public InvOfferComUsu(1) As New clsGrapchicalInventory
...
'     Constantes de Sonidos de caminata
Public Const SND_PASOS1 As String = "23.Wav"
Public Const SND_PASOS2 As String = "24.Wav"
Public Const SND_PASTO1 As String = "211.Wav"
Public Const SND_PASTO2 As String = "212.Wav"
Public Const SND_NIEVE1 As String = "213.Wav"
Public Const SND_NIEVE2 As String = "214.Wav"
...
'     Configuración de intervalos y Macros
...
'     COMO ODIO ESTO, DESDE CUANDO ELEGIS TU CABEZA CUANDO NACES? =S
...
Public Const MENSAJE_SEGUROi_ACTIVADO As String = "Seguro de Items activado"
Public Const MENSAJE_SEGUROi_DESACTIVADO As String = "Seguro de Items desactivado"
...
Public Type acc
    ...
    BankITM(1 To 10) As obBankCuenta
End Type
Public Cuenta As acc

Public IndexSelectedUSer As Byte

Public Nombres As Byte
...
Public UserParalizadoTime As Byte
Public UserInvisibilidadTime As Byte
